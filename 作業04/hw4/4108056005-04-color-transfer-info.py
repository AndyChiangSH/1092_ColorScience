# USAGE
# python 4108056005-04-color-transfer-info.py --source sou1.png --target tar1.png --output ult1.png
...
def color_transfer(source, target, clip=True, preserve_paper=True):
    ...
    # output sideinfodeci.txt
    with open("sideinfodeci.txt", "w") as file:
        file.write(str(round(lMeanTar, 4))+"\n")
        file.write(str(round(aMeanTar, 4))+"\n")
        file.write(str(round(bMeanTar, 4))+"\n")
        file.write(str(round(lStdTar, 4))+"\n")
        file.write(str(round(aStdTar, 4))+"\n")
        file.write(str(round(bStdTar, 4))+"\n")
        file.write(str(round(lMeanSrc, 4))+"\n")
        file.write(str(round(aMeanSrc, 4))+"\n")
        file.write(str(round(bMeanSrc, 4))+"\n")
        file.write(str(round(lStdSrc, 4))+"\n")
        file.write(str(round(aStdSrc, 4))+"\n")
        file.write(str(round(bStdSrc, 4))+"\n")
...
transfer = color_transfer(
    target, source, clip=args["clip"], preserve_paper=args["preservePaper"])
